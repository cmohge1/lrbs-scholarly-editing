...
How do you get from markdown to xml? The best option is to download [Pandoc](https://pandoc.org/). I love using Pandoc for all kinds of transformations (my favourite probably being the markdown > PDF transformation).

The other option is to open a new TEI-XML document in oXygen and simply copy-and-paste the body of the html file into the <body> element of the xml file.
